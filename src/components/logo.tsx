...
export default function Logo() {
    return <Link href="/" className="flex-grow flex items-end">
       <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 247.7 53" className="w-auto max-h-5 text-[--primary]"><path fill="currentcolor" d="M205.6,50.3c1.9-1,3.5-2.2,4.7-3.6v4.4v0.4h0.4h7.7h0.4v-0.4V13.5v-0.4h-0.4h-7.7h-0.4v0.4v4.3
	...
	c2.9-2.8,4.4-6.6,4.4-11.3C75.6,31.5,74.4,28,71.9,25.4z"></path><rect x="84.3" y="44.2" fill="currentcolor" width="6.9" height="6.9"></rect></svg>
        <span className="text-[--foreground] border rounded-full px-2 text-[8px] mt-1 font-medium block">community</span>
    </Link>
}